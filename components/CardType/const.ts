export const variantClasses = {
  episodesCard:
    " relative h-auto border-none rounded-2xl bg-secondary text-white z-0 m-4",
  ...
  pastEvents: " relative w-full flex",
  pulseCard:
    "my-5 flex flex-col bg-pulseCard relative hover:bg-pulseCardHover scale-100 hover:scale-105 transition duration-500 ease-in-out rounded-xl w-[90%] h-full",
  talkCard:
